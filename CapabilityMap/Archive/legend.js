...
function doAllLegends()
{
   ...
   var legend4 = d3.select(".legend")
    ...
    var legend9 = d3.select(".legend")
     ...
     dolegend(leg9,legend9,0);
}

function dolegend(data,legend,inc,label){
...
{
    showall=document.getElementById("cbshowall").checked; 
    if(showall) document.getElementById("cbshowapps").checked = true;
    if(showall) document.getElementById("cbshowpros").checked = true;
}

function setShowApps(obj)
{
    showapps=document.getElementById("cbshowapps").checked;    
}

function setShowPros(obj)
{
    showapros=document.getElementById("cbshowpros").checked;    
}
...
function focusarea(sel){
    ...
    svg.append("path")
                ...
                .attr("d",rightRoundedRect(0,0,102,h+2,5))
                .attr("stroke-width","4")
